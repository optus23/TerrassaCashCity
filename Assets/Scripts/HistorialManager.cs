...
public class HistorialManager : MonoBehaviour
{
    ...
    List<Text> ProductPerson_txt = new List<Text>();
    ...
    void Start()
    {
        ...
        for (int i = 0; i < product_count; ++i)
        {
            ...
            GameObject Person = new GameObject("Person " + i);
            Person.transform.SetParent(Historial.transform);
            ...
            ProductPerson_txt[i].transform.localScale = new Vector3(0.88f, 0.88f, 0.88f);
            ...
            ProductPerson_txt[i].GetComponent<RectTransform>().sizeDelta = new Vector2(130, 60);

            ProductName_txt[i].transform.localPosition = new Vector2(-34.3f, 98 + (offset * i));
            ProductCost_txt[i].transform.localPosition = new Vector2(44.6f, 98 + (offset * i));
            ProductDate_txt[i].transform.localPosition = new Vector2(102.6f, 98 + (offset * i));
            ProductPerson_txt[i].transform.localPosition = new Vector2(172.6f, 98 + (offset * i));
        }
    }
